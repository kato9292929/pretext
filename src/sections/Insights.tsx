...
const ARCHIVE: Item[] = [
  ...
  { href: 'https://note.com/x402inc/n/nc4a1b2152072', tag: tag('Nowcall'),
    title: { ja: 'Japan Inflation Nowcall 2026-08-18：観測再開と盛夏の野菜高による指数の上振れ', en: 'Japan Inflation Nowcall 2026-08-18: observation resumes and a midsummer vegetable spike lifts the index' } },
