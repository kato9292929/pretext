...
const JA: T = {
  ...
  'pf.1': 'ユーザーが円でチャージ',
  'pf.2': 'Agent WalletでUSDCに自動スワップ',
  'pf.3': 'Claude CodeがMCPツールを呼び出し',
  'pf.4': 'MCPサーバーがx402で自動決済・リトライ',
  'pf.5': 'Policy Engineが予算チェック・監査ログ記録',
  ...
  // Use case table
  'usecase.table.title': 'x402 or MPP——どちらが最適か',
  'usecase.th.usecase':  'ユースケース',
  'usecase.th.solution': '最適な方式',
  'usecase.row1.case':   'ECショッピング・AIによる代行注文',
  'usecase.row1.sol':    'クレカ × AIエージェント（現在主流）',
  'usecase.row2.case':   'APIコール・マイクロ課金',
  'usecase.row2.sol':    'x402',
  'usecase.row3.case':   '物理サービスへの自律決済（PostalForm等）',
  'usecase.row3.sol':    'x402',
  'usecase.row4.case':   '予算付き複数サービス自律運用',
  'usecase.row4.sol':    'x402 + Policy Engine',
  'usecase.row5.case':   'LLMトークン単位の高頻度課金',
  'usecase.row5.sol':    'MPP Sessionモード',

  // Paradigm split
  'paradigm.old.label':   '現在の主流',
  'paradigm.old.title':   '「人間の代わりに注文」',
  'paradigm.old.desc':    'クレカ × AIエージェント<br>EC・小売・代行購入',
  'paradigm.old.example': 'GAP × Gemini × Google Pay など',
  'paradigm.new.label':   '新しいレイヤー',
  'paradigm.new.title':   '「自律的な購入」',
  'paradigm.new.desc':    'x402 × MCP × Agent Wallet<br>APIリソースの自律調達',
  'paradigm.new.example': 'AIが仕事に必要なリソースを自ら買う',

  // What agents can buy with x402
  'agent.buy.title': 'AIエージェントがx402で買えるもの',
  'agent.buy.cat1':  'APIコール',
  'agent.buy.ex1':   'LLM推論、検索、翻訳、OCRなど',
  'agent.buy.cat2':  'データ',
  'agent.buy.ex2':   'リアルタイム情報、金融データ、空撮データフィード',
  'agent.buy.cat3':  'コンテンツ',
  'agent.buy.ex3':   '有料記事、レポート、画像・動画',
  'agent.buy.cat4':  'コンピュート',
  'agent.buy.ex4':   'GPUジョブ、ヘッドレスブラウザ処理',
  'agent.buy.cat5':  'ツール実行',
  'agent.buy.ex5':   'Webスクレイピング、ブラウザ操作',
  'agent.buy.cat6':  'ストレージ/CDN',
  'agent.buy.ex6':   'ファイル保存・取得',

  // 5 specific use cases
  'uc.1.title': 'APIコール・マイクロ課金',
  'uc.1.body':  'Claude Code・LangChain・CrewAIはx402ペイメントアダプターを標準搭載しています。エージェントが402レスポンスを受け取ると、Agent Walletの残高を自動確認して支払い、即座にリトライします。月額固定費も事前登録も必要ありません。',
  'uc.2.title': '登録・APIキー不要のデータ取得',
  'uc.2.body':  'APIキーは「誰が叩いているか」を識別しますが、エージェントが何百ものサービスを同時利用するとき管理が破綻します。x402は「支払われているか」だけを問います。ウォレット残高さえあれば即アクセス——オンボーディング不要。',
  'uc.3.title': '物理サービスへの自律決済',
  'uc.3.body':  'PostalFormの事例：Claude Codeが確定申告書を作成し、x402経由で$3.80を支払い、郵便局に送付——すべて人間の操作なしに完了しました。x402はAPIの外、リアルワールドのサービスへの自律決済も可能にします。',
  'uc.4.title': 'Agent Wallet × Policy Engine',
  'uc.4.body':  'Policy Engineでエージェントの支出を細かく制御できます。1トランザクション上限・加盟店許可リスト・時間あたり予算・監査ログをすべて搭載。solana.newではAgent Walletを標準スキルとして提供しており、Claude Codeのプロンプト1行で生成できます。',
  'uc.5.title': 'APAC向けAPI事業者のx402対応',
  'uc.5.body':  'x402対応APIは、AIエージェントから自動的に購入されます。StripeダッシュボードからONにするだけで、LangChain・CrewAI・Claude MCPの何百万ものエージェントから見つかるようになります。x402 Inc.は日本・APAC地域の事業者の対応を支援しています。',

  // Usecase conclusion
  'usecase.conclusion': 'クレカ×AIエージェントによる代行注文が引き続き主流です。x402×MCPはその一段下——AIが仕事に必要なAPIリソースを自律的に調達するという、新しいレイヤーのユースケースを生み出しています。',

  // Updated payment flow (5 steps, MCP × x402)
  'protocol.flow.title': 'AIエージェントの資金フロー（MCP × x402）',
...
const EN: T = {
  ...
  'pf.2': 'Auto-swap to USDC in Agent Wallet',
  'pf.3': 'Claude Code calls MCP tool',
  'pf.4': 'MCP server settles via x402, retries automatically',
  'pf.5': 'Policy Engine checks budget, logs to audit trail',
  ...
  // Use case table
  'usecase.table.title': 'x402 or MPP——which fits best',
  'usecase.th.usecase':  'Use case',
  'usecase.th.solution': 'Best approach',
  'usecase.row1.case':   'E-commerce, AI proxy purchasing',
  'usecase.row1.sol':    'Credit card × AI agent (current mainstream)',
  'usecase.row2.case':   'API calls & micropayments',
  'usecase.row2.sol':    'x402',
  'usecase.row3.case':   'Autonomous physical service payments (PostalForm)',
  'usecase.row3.sol':    'x402',
  'usecase.row4.case':   'Budgeted multi-service autonomous operation',
  'usecase.row4.sol':    'x402 + Policy Engine',
  'usecase.row5.case':   'High-frequency LLM token billing',
  'usecase.row5.sol':    'MPP Session mode',

  // Paradigm split
  'paradigm.old.label':   'Current mainstream',
  'paradigm.old.title':   '"Order on behalf of humans"',
  'paradigm.old.desc':    'Credit card × AI agent<br>E-commerce, retail, proxy purchasing',
  'paradigm.old.example': 'GAP × Gemini × Google Pay and others',
  'paradigm.new.label':   'New layer',
  'paradigm.new.title':   '"Autonomous purchasing"',
  'paradigm.new.desc':    'x402 × MCP × Agent Wallet<br>Self-sourcing API resources',
  'paradigm.new.example': 'AI buys what it needs to do its job',

  // What agents can buy with x402
  'agent.buy.title': 'What AI agents can buy with x402',
  'agent.buy.cat1':  'API calls',
  'agent.buy.ex1':   'LLM inference, search, translation, OCR, etc.',
  'agent.buy.cat2':  'Data',
  'agent.buy.ex2':   'Real-time feeds, financial data, aerial data feeds',
  'agent.buy.cat3':  'Content',
  'agent.buy.ex3':   'Paywalled articles, reports, images & video',
  'agent.buy.cat4':  'Compute',
  'agent.buy.ex4':   'GPU jobs, headless browser processing',
  'agent.buy.cat5':  'Tool execution',
  'agent.buy.ex5':   'Web scraping, browser automation',
  'agent.buy.cat6':  'Storage / CDN',
  'agent.buy.ex6':   'File storage and retrieval',

  // 5 specific use cases
  'uc.1.title': 'API Calls & Micropayments',
  'uc.1.body':  'Claude Code, LangChain, and CrewAI ship x402 payment adapters by default. When an agent hits a 402, it checks Agent Wallet balance, settles, and retries instantly. No monthly fees, no pre-registration.',
  'uc.2.title': 'Data Access Without Keys or Registration',
  'uc.2.body':  'API keys ask "who is calling"—but when agents use hundreds of services at once, that breaks down. x402 only asks "has payment been made?" Wallet balance = instant access. No onboarding required.',
  'uc.3.title': 'Autonomous Payments for Physical Services',
  'uc.3.body':  'PostalForm example: Claude Code prepares a tax return, pays $3.80 via x402, and requests postal delivery—all without human intervention. x402 enables autonomous payments to real-world services beyond APIs.',
  'uc.4.title': 'Agent Wallet × Policy Engine',
  'uc.4.body':  'Policy Engine gives fine-grained control: per-transaction limits, merchant allowlists, hourly budgets, and full audit logs. solana.new ships Agent Wallet as a standard skill—generate the full SDK with a single Claude Code prompt.',
  'uc.5.title': 'x402 Integration for APAC API Providers',
  'uc.5.body':  'x402-enabled APIs get automatically purchased by AI agents. Turn it on from the Stripe dashboard and become discoverable to millions of agents on LangChain, CrewAI, and Claude MCP. x402 Inc. supports Japan and APAC providers in joining the ecosystem.',

  // Usecase conclusion
  'usecase.conclusion': 'Credit card × AI agent proxy purchasing remains the mainstream. x402 × MCP operates one layer deeper—enabling AI to autonomously source the API resources it needs to do its job.',

  // Updated payment flow
  'protocol.flow.title': 'AI agent payment flow (MCP × x402)',
