...
const JA: T = {
  ...
  // TRADING STACK
  'tstack.badge':       '実証実験中',
  'tstack.title':       'オンチェーン・トレーディングスタック',
  'tstack.intro':       'x402 × Nansen × Claude AIで構築したオンチェーントレーディングインフラ。スマートマネーのシグナル検知から自律執行まで、エージェントがx402で自律決済しながら動く7層のスタックです。',
  'tstack.smss.desc':   'Nansenのスマートマネーデータをx402でゲート。STRONG BUYシグナルを検知してエージェントに返す。Base・Polygon・Solana対応。',
  'tstack.smss.verify': '検証：スマートマネーシグナルのx402従量課金モデル',
  'tstack.oif.desc':    'NansenのオンチェーンデータをClaudeが日本語で解析。APACの取引所フロー・クジラ動向・週次レポートを従量課金で配信。',
  'tstack.oif.verify':  '検証：AIによるオンチェーンデータ解析と日本語インテリジェンス配信',
  'tstack.aca.desc':    'World AgentKit × x402でAPAC5カ国のKYB・AMLスクリーニングを実装。執行前のコンプライアンス確認をエージェントが自律実行。',
  'tstack.aca.verify':  '検証：エージェントによる自律KYB・AMLスクリーニング',
  'tstack.smct.desc':   'スマートマネーのシグナル検知からCoinbase AgentKitによる自動執行まで一体化。Screenerが「見る」ツールなら、これは「動く」ツール。',
  'tstack.smct.verify': '検証：シグナル検知から執行までの自律トレーディングフロー',
  'tstack.wid.desc':    '$100K以上の大口移動を検知し、ウォレットの過去90日の行動履歴からClaudeが意図を5分類。「移動の事実」ではなく「移動の意図」を返す。',
  'tstack.wid.verify':  '検証：大口ウォレット行動のAI推論とx402課金モデル',
  'tstack.amp.desc':    'Nansen×Claudeが生成したオンチェーンリサーチレポートを購入・転売できる市場。転売時に80%が転売者の収益に、20%がプロトコルへ還元。',
  'tstack.amp.verify':  '検証：AIが生成したレポートの転売市場とx402収益分配',
  'tstack.npda.desc':   'Nansenのスマートマネーデータ×Polymarketの予測市場データを統合分析。「オンチェーンとオフチェーンの予測が乖離しているトークン」を検出。',
  'tstack.npda.verify': '検証：オンチェーン×予測市場の乖離検出とAI統合分析',
  'tstack.aa.desc':     '19本のAPIを横断して毎朝6時JSTに自動起動する自律エージェント。x402で自律決済しながらシグナル検知・分析・執行を実行。AI ↔ AI ループの実証。',
  'tstack.aa.verify':   '検証：供給側（API）と需要側（エージェント）を自前で持つ AI ↔ AI ループ',
...
const EN: T = {
  ...
  // TRADING STACK
  'tstack.badge':       'In Testing',
  'tstack.title':       'Onchain Trading Stack',
  'tstack.intro':       'An onchain trading infrastructure built with x402 × Nansen × Claude AI. A 7-layer stack where agents operate with autonomous x402 payments — from smart money signal detection through to autonomous execution.',
  'tstack.smss.desc':   'Nansen smart money data gated by x402. Detects STRONG BUY signals and returns them to agents. Supports Base, Polygon, and Solana.',
  'tstack.smss.verify': 'Proof of concept: x402 pay-per-query model for smart money signals',
  'tstack.oif.desc':    'Claude analyzes Nansen onchain data and delivers it in Japanese. APAC exchange flows, whale activity, and weekly reports on a pay-per-use basis.',
  'tstack.oif.verify':  'Proof of concept: AI-driven onchain data analysis and Japanese-language intelligence delivery',
  'tstack.aca.desc':    'KYB & AML screening across 5 APAC countries implemented with World AgentKit × x402. Agents autonomously execute pre-trade compliance checks.',
  'tstack.aca.verify':  'Proof of concept: autonomous KYB & AML screening by agents',
  'tstack.smct.desc':   'Integrates smart money signal detection through autonomous execution via Coinbase AgentKit. If the Screener "watches", this one "acts".',
  'tstack.smct.verify': 'Proof of concept: autonomous trading flow from signal detection to execution',
  'tstack.wid.desc':    'Detects transfers over $100K and uses Claude to classify wallet intent into 5 categories based on 90-day behavior history. Returns "why the move" not just "the move".',
  'tstack.wid.verify':  'Proof of concept: AI reasoning for large wallet behavior and x402 billing model',
  'tstack.amp.desc':    'A market for purchasing and reselling onchain research reports generated by Nansen × Claude. On resale, 80% goes to the reseller and 20% to the protocol.',
  'tstack.amp.verify':  'Proof of concept: resale market for AI-generated reports with x402 revenue sharing',
  'tstack.npda.desc':   'Integrates Nansen smart money data with Polymarket prediction market data. Detects tokens where onchain and offchain predictions diverge.',
  'tstack.npda.verify': 'Proof of concept: onchain × prediction market divergence detection with AI analysis',
  'tstack.aa.desc':     'An autonomous agent that auto-starts daily at 6AM JST across 19 APIs. Executes signal detection, analysis, and execution while settling autonomously via x402. AI ↔ AI loop in practice.',
  'tstack.aa.verify':   'Proof of concept: AI ↔ AI loop with both supply-side (APIs) and demand-side (agent) self-owned',
