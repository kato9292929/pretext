...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .board{width:1920px;height:1080px;background:#000;padding:88px 96px;position:relative;overflow:hidden;display:flex;flex-direction:column}
  ...
  /* PRODUCTS */
  .prow4{display:grid;grid-template-columns:repeat(4,1fr);gap:26px;flex:1}
  ...
  .pdesc{color:var(--muted);font-size:17px;line-height:1.6;flex:1}
  ...
  /* ENDPOINTS */
  .ebody{display:grid;grid-template-columns:1.1fr 2.4fr;gap:34px;flex:1}
